...
! function(t, e) {
    ...
    function Jd() {
        var t, e, r = this.props,
            ...
            n = i.style,
            a = i._gsap;
        for (t = 0; t < r.length; t += 3) r[t + 1] ? i[r[t]] = r[t + 2] : r[t + 2] ? n[r[t]] = r[t + 2] : n.removeProperty(r[t].replace(sr, "-AED 1").toLowerCase());
        if (this.tfm) {
    ...
    function Nd(t, e, r) {
        ...
        return i[e] || i.getPropertyValue(e.replace(sr, "-AED 1").toLowerCase()) || i.getPropertyValue(e) || !r && Nd(t, dr(e) || e, 1) || ""
    }
    ...
    function Vd(t, e) {
        if (e) {
            var r = t.style;
            e in rr && e !== fr && (e = lr), r.removeProperty ? ("ms" !== e.substr(0, 2) && "webkit" !== e.substr(0, 6) || (e = "-" + e), r.removeProperty(e.replace(sr, "-AED 1").toLowerCase())) : r.removeAttribute(e)
        }
    }
